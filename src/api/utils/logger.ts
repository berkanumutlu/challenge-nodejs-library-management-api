...
export const createConsoleLog = (req: CustomRequest, res: CustomResponse, next: CustomNext): void => {
    console.log(`${new Date().toUTCString()} - ${req.method} ${req.url}`);
    next();
};
// Creates a log message
export const createLogMessage = (err: Error, req: CustomRequest, res: CustomResponse): string => {
...
const appendLogFile = (err: Error, req: CustomRequest, res: CustomResponse): void => {
...
export const createNewLog = async (err: Error, req: CustomRequest, res: CustomResponse, next?: CustomNext): Promise<void> => {
